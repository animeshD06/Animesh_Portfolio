...
export const metadata: Metadata = {
  applicationName: "Animesh Abhi Dubey",
  title: "Animesh Abhi Dubey",
  description:
    "Animesh Abhi Dubey is a student developer passionate about building modern web apps with Next.js, React, and open-source tools. Explore his projects, experiments, and developer portfolio.",
  authors: [
    {
  ...
  keywords: keywords,
  metadataBase: new URL(process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : "https://animeshd.vercel.app/"),


  alternates: {
    canonical: process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : "https://animeshd.vercel.app/",
    languages: {
      "en-US": process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : "https://animeshd.vercel.app/",
    },
  },
  robots: {
    index: true,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Animesh Abhi Dubey Portfolio Thumbnail",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "Animesh Abhi Dubey | Student Developer",
    description:
